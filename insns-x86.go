...
func init() {
	...
	SizeInsn_x86_64 = map[string]string{
		...
		"padd":   "Add Packed ${SIZE} Integers",
		"pcmpeq": "Compare Packed ${SIZE} Data to Equal",
		"pcmpgt": "Compare Packed ${SIZE} Data to Greater Than",
		"pextr":  "Extract ${SIZE} Data",
		"pinsr":  "Insert ${SIZE} Data",
		"pmaxs":  "Maximum of Packed Signed ${SIZE} Integers",
		"pmaxu":  "Maximum of Packed Unsigned ${SIZE} Integers",
		"pmins":  "Minimum of Packed Signed ${SIZE} Integers",
		"pminu":  "Minimum of Packed Unsigned ${SIZE} Integers",
		"psign":  "Packed SIGN on ${SIZE} Data",
		"psll":   "Shift Packed ${SIZE} Data Left Logical",
		"psub":   "Subtract Packed ${SIZE} Integers",
		"scas":   "Scan ${SIZE} String",
