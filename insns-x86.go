...
func init() {
	Insn_x86_64 = map[string]string{
		...
		"cltq":             "Convert Long to Quadword: CDQE",
		...
		"cqo":              "Convert Doubleword to Quadword",
		...
		"cwtl":             "Convert Word to Doubleword: CWDE",
		...
		"movdqa":           "Move Aligned Double Quadword  [SSE2]",
		...
		"mulsd":            "Multiply Scalar Double-Precision Floating-Point Values  [SSE2]",
		...
		"vmovdqa32":        "Move Aligned Packed Doubleword Values  [AVX512]",
		"vmovdqa64":        "Move Aligned Packed Quadword Values  [AVX512]",
		...
		"vmovdqu32":        "Move Aligned Packed Doubleword Values  [AVX512]",
		"vmovdqu64":        "Move Aligned Packed Quadword Values  [AVX512]",
